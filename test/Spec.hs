...
-- Functor props Vectors
-- Functor props Matrices
-- Applicative props Vectors
-- Applicative props Matricies
-- mandelbrotFunc
-- compute
-- pickColour
--
...
--plot :: Nat -> Nat ->
--        ComputationInfo Double ->
--        Palette ->
--        Zoom ->
--        Either String (Frame m n)

--data ComputationInfo a =
--  ComputationInfo { func :: Complex a -> Complex a -> Complex a
--                  , orbitRad :: a
--                  , initVal :: Complex a }
--data Zoom a =
--    Zoom { origin :: Complex a
--         , factor :: Complex a }
--
